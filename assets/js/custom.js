...
jQuery(document).ready(function ($) {
  ...
  $('.js-cell').matchHeight(); // splash page hovers 
  ...
  */
  ...
  $('#map').mapster({
    ...
    render_highlight: {
      fillColor: 'ffffff',
      stroke: false //altImage: 'examples/images/usa_map_720_alt_4.jpg'
  ...
  var $alpha = $('#alpha');
  var $container = $('#beta');
  var $checkboxes = $('#filters input'); // init isotope, then insert all items from hidden #alpha

  $container.isotope({
    itemSelector: '.blog-square',
    masonry: {//columnWidth: 310
    },
    filter: '*',
    animationOptions: {
      duration: 750,
